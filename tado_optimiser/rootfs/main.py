...
def main():
    ...
    for room in THERMOSTATS:
        ...
        # Log initial entries
        logger.info(msg=f"Temperature: {room.current_temperature:.2f} | Climate: {room.climate_gas.upper()} | Mode: {room.tado_mode.upper()} | Electric Override: {str(room.electric_override).upper()}")
